package calendar.sample;//package calendar.calendar.sample;
//
//
...
//
//        for(int i=0;i<FXMLDocumentController.terms.length;i++)
//        {
//            if (FXMLDocumentController.terms[i].equals(termName))
//                termIndex = i;
//        }
//        int termID;
//        //Get the ID of the term to be updated
//        for(Map.Entry entry: addEvent.hashTable.entrySet()){
//            if(new Term(termName,currentTermDate).equals(entry.getValue())){
//                termID = Integer.parseInt(entry.getKey().toString());
